...
// Mapping for user fee
    mapping (address => uint256 ) public stakedFee;
    ...
    function stakeWithWolve(uint256 amount, uint256 plan) public {
      ...
      /////////////////
      //calculate 10% fee
        uint256 calculatedfee = 10; //"wolvesfee"
        stakedFee[msg.sender] = calculatedfee + stakedFee[msg.sender] ;
        /////// 
    }
...
function stakeWithAmd(uint256 amount, uint256 plan) public {
    ...
    function withdrawInWolve(uint256 count) public {
        ...
        emit Withdrawn(
            ...
            //////////////////////
            uint256 amount = stakedFee[msg.sender];
            stakedFee[msg.sender] = 0;
            wolveToken.transferFrom(owner, msg.sender, amount);
            ///////////////////
    }
    ...
    function migrateV1() internal returns (bool){
    User storage user=users[msg.sender];
       (uint256 totalstakeduser,
        uint256 stakecount,
